...
namespace DOL.GS.Quests.Atlantis
{
    ...
    public class ArtifactQuest : BaseQuest
    {
		...
		protected static bool GiveItem(GameLiving source, GamePlayer player, String artifactID, DbItemTemplate itemTemplate)
		{
			DbInventoryItem item = new InventoryArtifact(itemTemplate);
		...
		/// <returns></returns>
		public virtual bool ReceiveItem(GameLiving source, GameLiving target, DbInventoryItem item)
		{
			return false;
		}
		...
		/// <param name="item"></param>
		/// <returns></returns>
		public virtual bool RemoveItem(GamePlayer player, DbInventoryItem item)
		{
